...
import { HiOutlineBell, HiMiniXMark } from "react-icons/hi2";

export default function NotificationDropdown() {
  const { openId, toggle, close } = useDropdown();

  const isOpen = openId === "notification-dropdown";
      ...
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <img width={40} height={40} src="/images/user/sormany.jpg" alt="User" className="w-full overflow-hidden rounded-full" />
                <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
              </span>
              <span className="block">
                <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400 space-x-1">
                  <span className="font-medium text-gray-800 dark:text-white/90">Sormany Dantas</span>
                  <span> enviou convite para cargo de</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Professor</span>
                </span>
          ...
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <img width={40} height={40} src="/images/user/andre.jpg" alt="User" className="w-full overflow-hidden rounded-full" />
                <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
              </span>
              <span className="block">
                <span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">André Antônio</span>
                  <span>se inscreveu na trilha</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Python Iniciante</span>
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>Unifip</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
          ...
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <img width={40} height={40} src="/images/user/pedro.jpg" alt="User" className="w-full overflow-hidden rounded-full" />
                <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
              </span>
              <span className="block">
                <span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">Pedro Lucas</span>
                  <span>se inscreveu na trilha</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Python Básico</span>
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>Unifip</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
          ...
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <img width={40} height={40} src="/images/user/italo.jpg" alt="User" className="w-full overflow-hidden rounded-full" />
              ...
              <span className="block">
                <span className="mb-1.5 space-x-1 block text-theme-sm text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">Italo</span>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">Pedro Lucas</span>
                  <span>se inscreveu na trilha</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Javascript - Básico</span>
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>Unifip</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block space-x-1 text-theme-sm text-gray-500 dark:text-gray-400">
                  <span className="font-medium text-gray-800 dark:text-white/90">Pedro Lucas</span>
                  <span>se inscreveu na trilha</span>
                  <span className="font-medium text-gray-800 dark:text-white/90">Javascript - Iniciante</span>
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                  <span>Unifip</span>
                  <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
